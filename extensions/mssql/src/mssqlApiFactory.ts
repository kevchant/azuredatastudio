...
import { IExtension, ICmsService, IDacFxService, ISchemaCompareService, IUpdateLocalProjectService, MssqlObjectExplorerBrowser, ILanguageExtensionService, ISqlAssessmentService, ISqlMigrationService } from './mssql';
...
export function createMssqlApi(context: AppContext): IExtension {
	return {
		...
		get updateLocalProject() {
			return context.getService<IUpdateLocalProjectService>(constants.UpdateLocalProjectService);
		},
